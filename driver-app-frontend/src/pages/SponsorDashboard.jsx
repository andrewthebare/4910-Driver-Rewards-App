  ...
  return(
    <div>
      ...
      {sponsor && <div className='dashHolder'>
        ...
        <DashboardCard text='Create Application' to="/ApplicationCreation" src='https://images.pexels.com/photos/955389/pexels-photo-955389.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500' />
        <DashboardCard text='View and Edit Application' to="/ApplicationViewer" src='https://images.pexels.com/photos/4792288/pexels-photo-4792288.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500' />
        <DashboardCard text='Submitted Applications' to="/ApplicationChoice" src='https://images.pexels.com/photos/3760067/pexels-photo-3760067.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500' />
