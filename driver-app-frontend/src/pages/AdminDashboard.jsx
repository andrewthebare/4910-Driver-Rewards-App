  ...
  return(
    <div>
      ...
      {admin && <div className='dashHolder'>
        ...
        <DashboardCard text='View Sponsor' src='https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fwww.publicdomainpictures.net%2Fpictures%2F150000%2Fvelka%2Ftruck-on-the-road.jpg&f=1&nofb=1' to="/adminDashboard/Logs"/>
      </div> }
    </div>
  )
}
